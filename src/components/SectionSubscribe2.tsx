  ...
  return (
    <div className={`relative flex flex-col lg:flex-row lg:items-center ${className}`}>
      <div className="mb-10 shrink-0 lg:me-10 lg:mb-0 lg:w-2/5">
        ...
        <Subheading className="mt-5 max-w-sm">
          Get exclusive deals and inspiration delivered straight to your inbox.
        </Subheading>
        <ul className="mt-10 space-y-4">
          ...
          <li className="flex items-center gap-x-4">
            ...
            <span className="font-medium text-neutral-700 dark:text-neutral-300">Get premium deals</span>
          </li>
          <li className="flex items-center gap-x-4">
            <Badge color="fuchsia">03</Badge>
            <span className="font-medium text-neutral-700 dark:text-neutral-300">Endless inspiration</span>
          </li>
        </ul>
