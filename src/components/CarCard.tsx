...
const CarCard: FC<CarCardProps> = ({ size = 'default', className = '', data }) => {
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-3xl border border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-900 ${className}`}
    >
      <Link href={listingHref} className="absolute inset-1 z-1 focus:outline-none"></Link>
