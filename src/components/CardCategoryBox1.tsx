...
const CardCategoryBox1: FC<CardCategoryBox1Props> = ({ className = '', category }) => {
  ...
  return (
    <Link
      href={href}
      className={`card-category-box-1 group/card relative flex items-center nc-box-has-hover p-3 sm:p-6 ${className}`}
    >
      ...
      <div className="relative size-24 shrink-0 overflow-hidden rounded-full">
        <Image
          ...
          className="rounded-full object-cover transition-[filter] group-hover/card:brightness-75"
        />
      </div>
